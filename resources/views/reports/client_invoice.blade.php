...
<div class="">
    ...
    <div class="col-md-6">
        ...
        <br>
        <b>Address: </b>{{$client->address}}, {{$client->city}}, {{$client->state}}, {{$client->country}}
    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-center table-hover datatable" style="width:100%">
                        ...
                        <tr class="border-row">
                            ...
                            <th class="border-row" scope="col">Description</th>
                            <th class="border-row" scope="col">Rate</th>
                            <th class="border-row" scope="col">Weight</th>
                            <th class="border-row" scope="col">Rupees</th>
                        ...
                        @if($items)
                            @foreach($items as $item)
                                <tr class="border-row">
                                    ...
                                    <td class="border-row">{{$item->rupees}}</td>
